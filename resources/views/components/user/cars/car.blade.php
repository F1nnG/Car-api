...
<div class="my-4 mx-4 border rounded-lg shadow bg-gray-800 border-gray-700">
	<a href="{{ url("storage/$car->image") }}">
		<img class="rounded-t-lg w-full aspect-video object-cover bg-gray-700" src="{{ url("storage/$car->image") }}" alt="Car Image" />
	</a>
	<div class="p-5">
		...
		<a href="{{ route('cars.show', ['car' => $car->id]) }}">
			<button type="button" class="mb-1 text-sm font-medium bg-transparent text-white border-2 border-blue-500 rounded transition-all ease-in duration-75 hover:bg-blue-500">
